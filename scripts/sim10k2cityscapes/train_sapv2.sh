...
python tools/train_net.py --config-file "configs/sim10k2cityscapes/sapnetV2_R_50_C4.yaml" --num-gpus 1 \
--setting-token "sim10k2city-sapnetV2-l${weight_DA}-e${weight_entropy}-d${weight_diversity}" MODEL.DA_HEAD.LOSS_WEIGHT ${weight_DA} \
